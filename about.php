      ...
      <div class="row">
        <div class="col-lg-5 col-md-6">
          <div class="detail-box">
            ...
            <p>
            Computer Force is a brand-new start-up company that has set up its offices in the suburb of Parramatta in western Sydney. The business operations focus within the retail electronics industry. <br>
...
You can contact us using the following methods:<br>
<b>Address:</b> 100 Main Road, Parramatta, NSW 20150<br>
<b>Email:</b> info@computerforce.com.au<br>
<b>Phone:</b> 02 4444 5555
        ...
        <div class="col-lg-7 col-md-6">
          <div class="img-box">
            <img src="images/abou-us.jpg" alt="">
          </div>
        </div>
      </div>
    </div>
